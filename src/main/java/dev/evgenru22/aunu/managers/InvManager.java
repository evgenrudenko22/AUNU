...
public class InvManager {
	...
	private static void sabotageMap() {
		...
		for(int i = 0; i < sabotageMap.getSize(); i++)
			sabotageMap.setItem(i, genItem(Material.GLASS_PANE, "§7"));
		...
		sabotageMap.setItem(18, genItem(Material.INK_SAC, "Sabotage", 4, "§eReactor", Messages.sabType_reactor, "ID: reactor"));
